...
struct Net_Device {
  ...
  void (*getHeader) (struct Net_Device *, struct Net_Device_Header *, ulong_t);
...
/* Public functions */
int Register_Net_Device(struct Net_Device_Capabilities *, ulong_t, ulong_t, const char *nameBase);
int Unregister_Net_Device(struct Net_Device *);
int Get_Net_Device_By_Name(const char *name, /*@out@ */ struct Net_Device **device);
struct Net_Device_List *Get_Net_Device_List(void);
int Get_Net_Device_By_IRQ(unsigned int irq, /*@out@ */ struct Net_Device **device);
