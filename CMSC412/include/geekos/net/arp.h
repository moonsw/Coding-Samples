...
extern int ARP_Send_Request(struct Net_Device *, ushort_t htype, ushort_t ptype, const uchar_t protocolAddress[ARP_PROT_ADDR_SIZE]);
extern int ARP_Send_Request_And_Wait(struct Net_Device *, ushort_t htype, ushort_t ptype, ARP_Protocol_Address protocolAddress);
extern int ARP_Send_Reply(struct Net_Device *, struct ARP_Packet *, const uchar_t protocolAddress[ARP_PROT_ADDR_SIZE]);
...
extern int ARP_Resolve_Address(struct Net_Device *, ushort_t htype, ushort_t ptype, ARP_Protocol_Address protocolAddress, ARP_Hardware_Address hardwareAddress);
