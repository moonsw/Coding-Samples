...
extern int Eth_Transmit(struct Net_Device *dev, struct Net_Buf *nBuf, uchar_t * destAddr, ushort_t type);
...
extern int Eth_Dispatch_Table_Add(ushort_t, int (*)(struct Net_Device *, struct Net_Buf *));
