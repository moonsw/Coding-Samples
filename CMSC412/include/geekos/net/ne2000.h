...
extern void NE2000_Transmit(struct Net_Device *device, void *buffer, ulong_t length);
extern void NE2000_Receive(struct Net_Device *device, void *buffer, ulong_t length, ulong_t pageOffset);
extern void NE2000_Reset(struct Net_Device *device);
extern void NE2000_Get_Dev_Hdr(struct Net_Device *device, struct Net_Device_Header *hdr, ulong_t pageOffset);
extern void NE2000_Receive_Thread(struct Net_Device *device);
extern void NE2000_Transmit_Thread(struct Net_Device *device);
extern void NE2000_Complete_Receive(struct Net_Device *device, struct Net_Device_Header *hdr);
