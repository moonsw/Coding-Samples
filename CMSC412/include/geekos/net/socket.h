...
int Socket_Accept(ulong_t id, IP_Address * clientIpAddress, ushort_t * clientPort);
...
int Socket_Send_To(ulong_t id, uchar_t * buffer, ulong_t bufferSize, ushort_t port, IP_Address * ipAddress);
int Socket_Receive_From(ulong_t id, uchar_t * buffer, ulong_t bufferSize, ushort_t * port, IP_Address * ipAddress);
int Socket_Close(ulong_t id);
int Socket_Destroy(ulong_t id);

int Socket_Dispatch(struct IP_Device *device, uchar_t type, ushort_t destPort, ushort_t srcPort, IP_Address * destAddress,
  IP_Address * srcAddress, struct Net_Buf *nBuf, void *data);
