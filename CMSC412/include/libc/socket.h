...
int Send_To(ulong_t id, uchar_t * buffer, ulong_t bufferSize, ushort_t port, uchar_t ipAddress[4]);
int Receive_From(ulong_t id, uchar_t * buffer, ulong_t bufferSize, ushort_t * port, uchar_t ipAddress[4]);
